<x-form-component
    :method="'put'"
    :route="'longitudinal-profile-of-the-road.update'"
    :parameters="['longitudinal_profile_of_the_road'=>$longitudinalProfileOfTheRoad]"
    :element-id="'longitudinal-profile-of-the-road-update'"
>
