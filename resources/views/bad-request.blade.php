...
<body>
    <main class="grid w-full grow grid-cols-1 place-items-center bg-center min-h-100vh" style='background-image: url("{{asset('assets/images/illustrations/ufo-bg.svg')}}")'>
        <div class="max-w-[26rem] text-center">
            ...
            <a href="{{$backUrl}}" class="btn mt-8 h-11 bg-primary text-base font-medium text-white hover:bg-primary-focus hover:shadow-lg hover:shadow-primary/50 focus:bg-primary-focus focus:shadow-lg focus:shadow-primary/50 active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:hover:shadow-accent/50 dark:focus:bg-accent-focus dark:focus:shadow-accent/50 dark:active:bg-accent/90">
                Вернуться назад
            </a>
        </div>
    </main>
