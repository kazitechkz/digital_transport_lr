...
return new class extends Migration
{
    ...
    {
        Schema::create('landing_type_on_roadways', function (Blueprint $table) {
            $table->id();
            $table->integer('order');
            $table->float('start_m');
            $table->float('end_m');
            ...
            $table->unsignedBigInteger('landing_type_id');
            $table->timestamps();
            ...
            $table->foreign('landing_type_id')->references('id')->on('landing_types')->onDelete('cascade')->onUpdate('cascade');

            $table->index('side_id');
            $table->index('street_id');
            $table->index('landing_type_id');
        });
    }
    ...
    {
        Schema::dropIfExists('landing_type_on_roadways');
    }
};
